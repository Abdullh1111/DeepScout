...
/**
 * Reusable inline icon set for DeepScout.
 * Icons inherit `currentColor` and default to size-4 (16px) — override via
 * className, e.g. <SearchIcon className="size-5 text-muted" />.
 */
...
export function LogoMark({ className }: { className?: string }) {
  return (
    ...
    >
      <circle cx="12" cy="12" r="10" fill="var(--violet)" opacity="0.18" />
      <circle
        cx="12"
        cy="12"
        r="6"
        ...
        strokeWidth="2.5"
      />
      <circle cx="12" cy="12" r="2" fill="var(--violet)" />
    </svg>
  );
}
